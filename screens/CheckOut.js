        ...
        <ScrollView>
            <View style={styles.main}>
                ...
                <View style={styles.boxCard2}>
                    <View style={styles.cardContainer2}>
                        <View style={styles.cardContainer}>
                            <ImageBackground style={styles.imageBox} resizeMode="cover" source={{uri: "https://d1uz88p17r663j.cloudfront.net/original/f10d69e7fede5cd6200a8ddd41b3cb68_hamburguesa-parrillera.jpg"}}></ImageBackground>
                ...
                <View style={styles.buttonPayment}>
                    ...
                    <Text style={styles.buttonPrice}>$ total</Text>
                </View>
            </View>
        </ScrollView>
    )
