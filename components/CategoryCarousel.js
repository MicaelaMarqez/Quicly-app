    ...
    return (
      <View style={styles.card} key={index}>
        <View style={styles.slide}>
          <ImageBackground source={{ uri: `https://quickly-food.herokuapp.com${item.img}` }} style={styles.background}></ImageBackground>
          <View style={styles.infoContainer}>
            ...
            <View style={styles.containerPrice}>
              ...
              <Pressable style={styles.button}>
                <Text style={{ textAlign: 'center', color: 'white', fontSize: 22 }} onPress={() => props.navigation.navigate('Product')}>
                  +
                </Text>
              </Pressable>
            </View>
