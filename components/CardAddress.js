...
const CardAddress = ({ address, setAddressProfile, updateUser, selectActiveAddress, setModalVisible }) => {
  ...
  return (
    <View style={styles.boxCard}>
      ...
      <Pressable
        ...
        style={styles.button}
      >
        <Text style={styles.btnText}>{selectActiveAddress ? 'Seleccionar' : 'Borrar'}</Text>
      </Pressable>
    </View>
  )
}
